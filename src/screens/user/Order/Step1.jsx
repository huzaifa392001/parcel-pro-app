...
import { bgColor, generalFontSize, GlobalStyle, textColor } from '../../../styles/Theme'
        ...
        <ScrollView>
          <View style={GlobalStyle.container}>
                ...
                <View style={GlobalStyle.picturePreview}>
                  ...
                  <View style={GlobalStyle.uploadBtnCont}>
                    <TouchableOpacity onPress={openImagePicker} style={GlobalStyle.uploadBtn}>
                      <Text style={GlobalStyle.pictureText}>Click to Upload Image</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={openCamera} style={[GlobalStyle.uploadBtn, { borderLeftWidth: 2, borderLeftColor: bgColor }]}>
                      <Text style={GlobalStyle.pictureText}>Click to Open Camera</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </View>
            ...
            <View style={[GlobalStyle.inputCont, GlobalStyle.submitBtnCont]}>
              <TouchableOpacity onPress={() => navigation.navigate("step2")} style={GlobalStyle.themeBtn}>

...
import { bgColor, generalFontSize, secondaryColor, textColor, themeColor, whiteColor } from '../styles/Theme'
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.tranking}>
        ...
        <View style={[styles.currentPoint, styles.point, { left: props?.status ?? "25%" }]} >
